...
- Add regression coverage near the affected concern, such as [spec/cli_inventory_spec.cr](../spec/cli_inventory_spec.cr), [spec/cli_hosts_spec.cr](../spec/cli_hosts_spec.cr), [spec/cli_updates_spec.cr](../spec/cli_updates_spec.cr), [spec/update_planner_spec.cr](../spec/update_planner_spec.cr), [spec/update_runner_spec.cr](../spec/update_runner_spec.cr), [spec/update_integration_spec.cr](../spec/update_integration_spec.cr), or [spec/update_state_spec.cr](../spec/update_state_spec.cr).
