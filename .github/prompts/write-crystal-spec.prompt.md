...
- Put non-CLI update coverage in the nearest focused file: [spec/update_planner_spec.cr](../../spec/update_planner_spec.cr), [spec/update_runner_spec.cr](../../spec/update_runner_spec.cr), [spec/update_integration_spec.cr](../../spec/update_integration_spec.cr), or [spec/update_state_spec.cr](../../spec/update_state_spec.cr).
...
3. Cover both success and failure paths when the bug or feature warrants it, and add guard or JSON assertions when the behavior depends on them.
