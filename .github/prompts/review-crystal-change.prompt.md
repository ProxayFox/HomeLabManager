...
- Check for missing or weak spec coverage, especially in [spec/cli_inventory_spec.cr](../../spec/cli_inventory_spec.cr), [spec/cli_hosts_spec.cr](../../spec/cli_hosts_spec.cr), [spec/cli_updates_spec.cr](../../spec/cli_updates_spec.cr), [spec/updates_spec.cr](../../spec/updates_spec.cr), and [spec/update_state_spec.cr](../../spec/update_state_spec.cr).
- Check whether operator-facing or implementation docs should have been updated in [README.md](../../README.md), [wiki/README.md](../../wiki/README.md), or [.github/copilot-instructions.md](../copilot-instructions.md).
